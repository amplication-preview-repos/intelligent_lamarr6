...
@InputType()
class RecommendationCreateNestedManyWithoutImplantsInput {
...
export { RecommendationCreateNestedManyWithoutImplantsInput as RecommendationCreateNestedManyWithoutImplantsInput };
