...
@InputType()
class RecommendationCreateNestedManyWithoutPatientsInput {
...
export { RecommendationCreateNestedManyWithoutPatientsInput as RecommendationCreateNestedManyWithoutPatientsInput };
